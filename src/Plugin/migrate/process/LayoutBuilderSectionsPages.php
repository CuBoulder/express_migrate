...
class LayoutBuilderSectionsPages extends ProcessPluginBase {
  ...
  public function transform($value, MigrateExecutableInterface $migrate_executable, Row $row, $destination_property) {
    ...
    $allowedComponents[] = 'content_list';
    ...
    $allowedComponents[] = 'localist_events';
    $allowedComponents[] = 'collection_grid';
...
//         ];
        ...
        $destid = $lookup->lookup(['express_beans_feature_callout', 'express_beans_block', 'express_beans_content_row', 'express_beans_content_sequence', 'express_beans_content_list', 'express_beans_video_hero_unit', 'express_beans_expandable', 'express_beans_slider', 'express_beans_video_reveal', 'express_beans_people_list_block', 'express_beans_block_wrapper', 'express_beans_article_slider', 'express_beans_article_grid', 'express_beans_article_feature', 'express_beans_articles', 'express_beans_hero_unit', 'express_beans_social_links', 'express_beans_localist_events', 'express_beans_collection_grid'], $component_id_array);
